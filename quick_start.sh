...
echo "  python scripts/train_baseline.py          # Train with sample data"
echo "  python scripts/train_with_real_data.py    # Train with real NFL data"
echo "  python scripts/predict.py                 # Make predictions"
echo "  python scripts/interactive_predictor.py   # Interactive predictions"
